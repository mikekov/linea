...
<inkscape version="1">
  ...
  <group id="colorselector" page="HSL" switcher="1">
    <group id="RGB"
      visible="1" />
    <group id="HSL"
      visible="1" />
  ...
  <group id="dialogs">
    ...
    <group id="import" enable_preview="1" forcexdpi="1" path="" ask="1" ask_svg="1" link="link" scale="optimizeSpeed">
      <group id="defaultxdpi" value="0"/>
    </group>
  ...
  <group id="options"
    ...
    <group id="defaultoffsetwidth" value="1px"/>
    <group id="defaultscale" value="1px"/>
    ...
    <group id="svgeditor" value="linea"/>
    ...
    <group id="transform" stroke="0" rectcorners="0" pattern="1" gradient="1" />
  ...
  <group id="desktop" style="fill:green">
    <group
       width="640"
       height="480"
       x="0"
