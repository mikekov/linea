...
public:
    ...
    void set_color(const unsigned r, const unsigned g, const unsigned b, unsigned a, bool const commit);
    ...
    Inkscape::CanvasItemGuideLine* findGuide(Inkscape::UI::Widget::Canvas* canvas) const;
