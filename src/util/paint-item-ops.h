...
public:
    ...
    struct StrokeWidthOp { double width; bool hairline; const Inkscape::Util::Unit* unit; };
...
void set_stroke_width(SPItem* item, double width, bool hairline, const ::Inkscape::Util::Unit* unit);
