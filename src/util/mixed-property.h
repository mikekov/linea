...
#ifndef LINEA_MIXED_PROPERTY_H
#define LINEA_MIXED_PROPERTY_H
...
// Backward-compat alias: files inside namespace Inkscape can still use
// bare mixed_property<T> without a qualifier change.
// namespace Inkscape { using Linea::mixed_property; }

#endif // LINEA_MIXED_PROPERTY_H
