...
std::unordered_map<std::string, CanvasItemCtrlType> const ctrl_type_map = {
    ...
    {".inkscape-selcue", CANVAS_ITEM_CTRL_TYPE_SELCUE},
    {".inkscape-selcue-2", CANVAS_ITEM_CTRL_TYPE_SELCUE_2},
...
std::unordered_map<std::string, CanvasItemCtrlShape> const ctrl_shape_map = {
    ...
    {"'corner-bl'", CANVAS_ITEM_CTRL_SHAPE_CORNER_BL},
    {"'corner-tr'", CANVAS_ITEM_CTRL_SHAPE_CORNER_TR}
};
