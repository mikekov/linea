...
void FilterDisplacementMap::render_cairo(FilterSlot &slot) const
{
    ...
    set_cairo_surface_ci(map, color_interpolation);
...
void FilterDisplacementMap::area_enlarge(Geom::IntRect &area, Geom::Affine const &trans) const
{
...
double FilterDisplacementMap::complexity(Geom::Affine const &) const
{
    return 3.0;
}
