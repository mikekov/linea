...
// Convert a pre-computed bounding box (in px) to display coordinates,
// applying anchor adjustment, page-origin correction, and unit conversion.
// bbox is the raw selection bounding box; the selection provides the anchor.
// Returns empty rect if bbox is nullopt or unit is dimensionless.
Geom::Rect sp_bbox_to_xywh(
    const Geom::OptRect& bbox,
