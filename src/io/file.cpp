...
std::pair<std::unique_ptr<SPDocument>, Linea::IO::FileError> ink_file_open(Glib::RefPtr<Gio::File> const &file)
{
    ...
    try {
        ...
        return {nullptr, Linea::IO::FileError(Linea::IO::OpenFailure::ExtensionNotFound)};
    } catch (Inkscape::Extension::Input::open_failed const &) {
        return {nullptr, Linea::IO::FileError(Linea::IO::OpenFailure::OpenError)};
    } catch (Inkscape::Extension::Input::open_cancelled const &) {
        return {nullptr, Linea::IO::FileError(Linea::IO::OpenFailure::Cancelled)};
    }
    ...
    return {std::move(doc), Linea::IO::FileError()};
}
