...
public:
    /**
     * Create an image from an ARGB32 premultiplied bitmap view.
     * The pixel data is copied (un-premultiplied) into internal storage,
     * while the confidence matrix is initialized to zero.
     */
    explicit SioxImage(const BitmapView& bmp);

    /**
     * Create a QImage (ARGB32 premultiplied) from this image.
     */
