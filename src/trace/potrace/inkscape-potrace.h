...
private:
    ...
    TraceResult traceQuant          (const BitmapView& bmp, Async::Progress<double> &progress);
    TraceResult traceBrightnessMulti(const BitmapView& bmp, Async::Progress<double> &progress);
    TraceResult traceSingle         (const BitmapView& bmp, Async::Progress<double> &progress);

    IndexedMap filterIndexed(const BitmapView& bmp) const;
    std::optional<GrayMap> filter(const BitmapView& bmp) const;
