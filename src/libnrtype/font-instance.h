...
private:
    ...
    double  _underline_position  = 0.0; // Underline position from font (em units, positive = below baseline).
    double  _underline_thickness = 0.0; // Underline thickness from font (em units).
