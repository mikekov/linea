...
bool PenTool::_handleKeyPress(KeyPressEvent const &event)
{
    ...
    switch (get_latin_keyval(event)) {
        case INK_KEY_Left: // move last point left
        case INK_KEY_KP_Left:
            ...
            break;
        case INK_KEY_Up: // move last point up
        case INK_KEY_KP_Up:
            if (!mod_ctrl(event)) { // not ctrl
                if (mod_alt(event)) { // alt
                    if (mod_shift(event)) {
            ...
            break;
        case INK_KEY_Right: // move last point right
        case INK_KEY_KP_Right:
            ...
            break;
        case INK_KEY_Down: // move last point down
