...
std::map<int, int> const &key_map()
{
    static const std::map<int, int> static_key_map = {
        {INK_KEY_Alt_L, INK_ALT_MASK},
        {INK_KEY_Alt_R, INK_ALT_MASK},
        {INK_KEY_Control_L, INK_CONTROL_MASK},
        {INK_KEY_Control_R, INK_CONTROL_MASK},
        {INK_KEY_Shift_L, INK_SHIFT_MASK},
        {INK_KEY_Shift_R, INK_SHIFT_MASK},
        {INK_KEY_Meta_L, INK_META_MASK},
        {INK_KEY_Meta_R, INK_META_MASK},
    };
