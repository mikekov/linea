...
public:
    ...
    bool isPointInViewport(Geom::Point pos) const;
    ...
    // TODO: move these functions out of here and into the Canvas or LineaWindow
    ...
    bool getShowBorder() const { return border_show; }
    bool getBorderOnTop() const { return border_on_top; }
    bool getShowShadow() const { return shadow_show; }
    std::string getLabelStyle() const { return label_style; }
