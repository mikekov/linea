...
void
canvas_set_state(LineaWindow *win, Glib::ustring action_name, bool state)
{
    // Get Action
...
bool
canvas_toggle_state(LineaWindow *win, Glib::ustring action_name)
{
    // Get Action
    auto action = win->lookup_action(action_name);
    if (!action) {
...
void
canvas_commands_bar_toggle(LineaWindow *win)
{
    // Toggle State
...
void
canvas_snap_controls_bar_toggle(LineaWindow *win)
{
    // Toggle State
...
void
canvas_tool_control_bar_toggle(LineaWindow *win)
{
    // Toggle State
...
void
canvas_toolbox_toggle(LineaWindow *win)
{
    // Toggle State
...
void
canvas_rulers_toggle(LineaWindow *win)
{
    // Toggle State
...
void
canvas_scroll_bars(LineaWindow *win)
{
    // Toggle State
...
void
canvas_palette_toggle(LineaWindow *win)
{
    // Toggle State
...
void
canvas_statusbar_toggle(LineaWindow *win)
{
    // Toggle State
...
void
canvas_interface_mode(LineaWindow *win)
{
    // Toggle State
...
void view_fullscreen(LineaWindow *win) {
    win->toggleFullscreen();
}

bool get_view_fullscreen(LineaWindow* wnd) {
    return wnd->getFullscreen();
}

void view_toggle_dialogs(LineaWindow* wnd) {
    wnd->toggleDialogs();
}

bool get_view_toggle_dialogs(LineaWindow* wnd) {
    return wnd->dialogsVisible();
}

void view_color_palette(LineaWindow* wnd) {
    wnd->toggleColorPalette();
}

void view_rulers(LineaWindow* wnd) {
    wnd->toggleRulers();
}

bool get_view_rulers(LineaWindow* wnd) {
    return wnd->rulersVisible();
}

bool get_view_color_palette(LineaWindow* wnd) {
    return wnd->colorPaletteVisible();
}

void view_full_screen_focus(LineaWindow* win) {
    win->toggleFullscreen();
    win->get_desktop()->focusMode(!win->isFullscreen());
}

void
view_focus_toggle(LineaWindow *win)
{
    SPDesktop* dt = win->get_desktop();
...
std::vector<std::vector<Glib::ustring>> raw_data_view_mode =
{
    ...
    {"win.view-fullscreen",          N_("Enter full screen"),       SECTION, N_("Stretch this document window to full screen")},
