...
void
transform_translate(const Glib::VariantBase& value, LineaApplication* app)
{
...
void
transform_scale(const Glib::VariantBase& value, LineaApplication* app)
{
...
void
transform_grow(const Glib::VariantBase& value, LineaApplication* app)
{
    auto scale = (Glib::VariantBase::cast_dynamic<Glib::Variant<double>>(value)).get();
...
void
transform_grow_step(const Glib::VariantBase& value, LineaApplication* app)
{
...
void
transform_grow_screen(const Glib::VariantBase& value, LineaWindow *win)
{
    auto scale = (Glib::VariantBase::cast_dynamic<Glib::Variant<double>>(value)).get();
...
void
transform_remove(LineaApplication *app)
{
    auto selection = app->get_active_selection();
...
void transform_reapply(LineaApplication *app)
{
    auto selection = app->get_active_selection();
...
void page_rotate(const Glib::VariantBase& value, LineaApplication *app)
{
...
void
add_actions_transform(LineaWindow* win)
{
    Glib::VariantType Double(Glib::VARIANT_TYPE_DOUBLE);
