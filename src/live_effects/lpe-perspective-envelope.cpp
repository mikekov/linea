...
LPEPerspectiveEnvelope::newWidget()
{
    ...
    auto* layout = new QVBoxLayout(vbox);
    ...
    auto* reset_button = new QPushButton(QString::fromUtf8(_("Clear")));
    QObject::connect(reset_button, &QPushButton::clicked, [this](){ resetGrid(); });
