...
LPEGears::LPEGears(LivePathEffectObject *lpeobject) :
    ...
    phi(_("_Phi:"), _("Tooth pressure angle (typically 20-25 deg).  The ratio of teeth not in contact."), "phi", &wr, this, 20, "°"),
    min_radius(_("Min Radius:"), _("Minimum radius, low values can be slow"), "min_radius", &wr, this, 5.0)
{
    ...
    phi.param_set_range(0.0, 45.0);
    phi.param_set_increments(1.0, 5.0);
    phi.param_set_digits(1);
