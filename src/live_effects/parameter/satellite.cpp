...
QWidget* SatelliteParam::param_newWidget()
{
    ...
    btn->setIcon(QIcon(":/icons/edit-clone"));
    btn->setToolTip(QObject::tr("Link to item on clipboard"));
    QObject::connect(btn, &QPushButton::clicked, [this] { on_link_button_click(); });
