...
LPEEnvelope::LPEEnvelope(LivePathEffectObject *lpeobject) :
    ...
    xx(_("_Enable left and right paths"), _("Enable the left and right deformation paths"), "xx", &wr, this, true),
    yy(_("_Enable top and bottom paths"), _("Enable the top and bottom deformation paths"), "yy", &wr, this, true)
{
