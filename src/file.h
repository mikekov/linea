 ...
 *
 */
bool sp_file_save (LineaWindow& parentWindow, void* object, void* data);
 ...
 */
bool sp_file_save_a_copy (LineaWindow& parentWindow, void* object, void* data);
 ...
 *  if needed.
 */
bool sp_file_save_document (LineaWindow& parentWindow, SPDocument *document);
